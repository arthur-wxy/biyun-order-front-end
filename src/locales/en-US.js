const enUS = {
  ...
  'order.search.productName': 'Product Name',
  'order.search.shippingFullName': 'Recipient Name',
  ...
  'table.operation.batchExport': 'Batch Export',
  ...
  'quotation.batchExport.success': 'Batch export successful',
  'quotation.batchExport.fail': 'Failed to batch export',
  'quotation.export.noData': 'No data selected for export',
  ...
  'order.column.productImage': 'Product Image',
  'order.column.noImage': 'No Image',
  'order.column.clickToPreview': 'Click to Preview',
  'order.edit.orderPreviewUrl': 'Order Preview URL',
  'order.edit.designUrl': 'Design URL',
  'order.edit.customizationUrl': 'Customization URL',
  'order.edit.customilyUniqId': 'Customily Unique ID',
  'order.edit.uniqField': 'Unique Field',
  'order.edit.fulfillmentFields': 'Fulfillment Fields',
  'order.edit.shopify': 'Shopify',
  'order.edit.shopifyProductType': 'Shopify Product Type',
  'order.edit.numberOfNames': 'Number of Names',
